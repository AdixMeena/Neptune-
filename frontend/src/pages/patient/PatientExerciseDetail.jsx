  ...
  return (
    <PatientApprovalGate showNav>
      ...
      <div style={{ padding: '56px 24px 20px', borderBottom: '1px solid #d2d2d7' }}>
        ...
        <div style={{ fontSize: 12, color: '#6e6e73', fontWeight: 600, marginBottom: 6, textTransform: 'uppercase', letterSpacing: 1 }}>
          {exercise.category}
        </div>
        <h1 style={{ fontSize: 32, fontWeight: 600, color: '#1d1d1f', fontFamily: '"Inter Tight", sans-serif', margin: 0, lineHeight: 1.09 }}>
          {exercise.name}
        </h1>
